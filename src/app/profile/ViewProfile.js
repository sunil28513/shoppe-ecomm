                        ...
                        <div className="col-md-9">
                            <div className="profile__main-inner d-flex flex-wrap align-items-center">
                                ...
                                <div className="profile__main-thumb-edit">
                                    ...
                                    <label for="profile-thumb-input"><BiCamera/></label>
                                </div>
                                </div>
                                <div className="profile__main-content">
                                <h4 className="profile__main-title">Welcome Mr. Sunil Kumar Yadav!</h4>
                                <p><BiEnvelope/> sunilyadav285166@gmail.com</p>
                                <p><BiPhone/>+91- 8604593185</p>
                                </div>
                            </div>
                        </div>
